...
class PymChatPlugin(Star):
    def __init__(self, context: Context):
        ...
        self.pending_login: Dict[int, str] = {}  # user_id -> pending_token
        self._load_config()
    ...
    async def cmd_login(self, event: AstrMessageEvent):
        ...
        if event.is_group_message:
            ...
            self.pending_login[user_id] = token
    ...
    @filter.command("pc_login_direct")
    async def cmd_login_direct(self, event: AstrMessageEvent):
        """
        ...
        # 验证token
        expected_token = self.pending_login.get(user_id)
